          ...
          {loading && (
            <div className="mt-6">
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  className="bg-gradient-to-r from-[#3B82F6] to-[#6366F1] h-2 rounded-full transition-all duration-300"
                  style={{ width: `${uploadProgress}%` }}
                />
              </div>
              <p className="text-center text-xs text-[#6B7280] mt-2">
                {uploadProgress < 30 && "📄 Reading resume..."}
                {uploadProgress >= 30 && uploadProgress < 70 && "🤖 Analyzing skills..."}
          ...
          <button
            ...
            className={`w-full mt-6 py-3 rounded-lg font-semibold text-white transition ${
              !file || loading
                ...
                : "bg-gradient-to-r from-[#3B82F6] to-[#6366F1] hover:shadow-lg hover:scale-[1.01] active:scale-[0.99]"
            }`}
          >
